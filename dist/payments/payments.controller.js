...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('nmi_merchants.create'),
    ...
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Missing permission: nmi_merchants.create' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.Permissions)('nmi_merchants.list'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Missing permission: nmi_merchants.list' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('nmi_merchants.show'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Missing permission: nmi_merchants.show' }),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('nmi_merchants.update'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Merchant not found at the payment provider' }),
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Missing permission: nmi_merchants.update' }),
    __param(0, (0, common_1.Param)('gatewayMerchantId')),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('nmi_merchants.delete'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Merchant not found at the payment provider' }),
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Missing permission: nmi_merchants.delete' }),
    __param(0, (0, common_1.Param)('gatewayMerchantId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('nmi_merchants.update_status'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Merchant not found at the payment provider' }),
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Missing permission: nmi_merchants.update_status' }),
    __param(0, (0, common_1.Param)('gatewayMerchantId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
